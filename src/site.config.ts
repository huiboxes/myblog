...
export const theme: ThemeUserConfig = {
  ...
  description: '一位开发者的思考与实践笔记。内容涵盖后端架构、前端技术、DevOps、开源工具，偶尔分享个人理财与成长心得。',
...
export const integ: Partial<IntegrationUserConfig> = {
  // Links management
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://codenlog.com/' },
      { name: 'Avatar', val: 'https://codenlog.com/favicon/favicon.ico' }
    ]
  },
